...
// import { 
//   // Assuming ChatRoomConcept is defined elsewhere (e.g., ChatRoomUtils or intended for chatRoomTypes)
//   // For now, we'll keep the filter UI, but actual filtering on 'concept' from API data won't work
//   // if ChatRoomMultiResponseDto doesn't include 'concept'.
//   ChatRoomConcept, 
//   RoomStatus as ChatRoomStatusEnum, // Renaming to avoid conflict if ChatRoomStatus type is also used
...
//     }));
//   }, [allChatRooms, conceptFilter, statusFilter, roomTypeFilter, roomIdSearch, sortValue]);
...
//       cellRenderer: (item) => (
//         <span className={`px-2.5 py-1 text-xs font-semibold rounded-full ${getChatRoomStatusBadgeStyle(item.roomStatus as ChatRoomStatusEnum)}`}>
//           {getChatRoomStatusLabel(item.roomStatus as ChatRoomStatusEnum)}
//         </span>
//       ),
//     },
